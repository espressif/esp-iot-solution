...
/**
 * @brief  Handle for the video explain client
 */
typedef struct esp_xiaozhi_video_ctx esp_xiaozhi_video_handle_t;
...
} esp_xiaozhi_video_frame_t;

/**
 * @brief  Configuration for the video explain client
 */
typedef struct {
    const char *explain_url;   /*!< Explain service URL */
    const char *explain_token; /*!< Optional bearer token */
} esp_xiaozhi_video_config_t;

/**
 * @brief  Create a video explain client handle
 *
...
/**
 * @brief  Destroy the video explain client handle
 *
