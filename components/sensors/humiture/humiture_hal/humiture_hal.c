...
static esp_err_t null_acquire_humidity_function(float *h){return ESP_ERR_NOT_FOUND;}
static esp_err_t null_acquire_temperature_function(float *t){return ESP_ERR_NOT_FOUND;}
