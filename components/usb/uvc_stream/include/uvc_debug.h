...
#define TRIGGER_IRP_PIN 11 //irp level trigger
#define TRIGGER_NEW_FARAME 12 //frame level trigger
#define TRIGGER_DECODER_PIN 13 //user level trigger
#define GPIO_OUTPUT_PIN_SEL  ((1ULL<<TRIGGER_DECODER_PIN) | (1ULL<<TRIGGER_NEW_FARAME) | (1ULL<<TRIGGER_IRP_PIN) | (1ULL<<TRIGGER_XFER_PIN))
...
#define TRIGGER_IRP_ENQUEUE() gpio_set_level(TRIGGER_IRP_PIN, 1)
#define TRIGGER_IRP_DEQUEUE() gpio_set_level(TRIGGER_IRP_PIN, 0)
...
static inline void trigger_init(void) {
    ...
    gpio_set_level(TRIGGER_IRP_PIN, 0);
...
#define TRIGGER_IRP_ENQUEUE()
#define TRIGGER_IRP_DEQUEUE()
