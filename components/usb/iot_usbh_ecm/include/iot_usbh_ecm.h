 ...
 */
typedef struct {
    bool auto_detect;                         /*!< Auto detect ECM device */
    ...
    int itf_num;                              /*!< ecm device notif interface numbers, used when auto_detect is false */
 ...
 *
 * @param config Pointer to the ECM configuration structure.
