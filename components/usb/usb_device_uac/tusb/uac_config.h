...
#define SPK_INTERVAL         CONFIG_UAC_SPK_INTERVAL         /*!< READ INTERVAL */
#define MIC_INTERVAL         CONFIG_UAC_MIC_INTERVAL         /*!< WRITE INTERVAL */
...
// N - Channels
#define TUD_AUDIO_DESC_FEATURE_UNIT_N_CHANNEL_LEN 6+(SPEAK_CHANNEL_NUM+1)*4
#define TUD_AUDIO_DESC_FEATURE_UNIT_N_CHANNEL(_unitid, _srcid, _stridx, ...) \
  TUD_AUDIO_DESC_FEATURE_UNIT_N_CHANNEL_LEN, TUSB_DESC_CS_INTERFACE, AUDIO_CS_AC_INTERFACE_FEATURE_UNIT, _unitid, _srcid, __VA_ARGS__, _stridx
