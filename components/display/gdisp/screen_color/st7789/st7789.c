...
lcd_driver_fun_t lcd_st7789_default_driver = {
...
esp_err_t lcd_st7789_init(const lcd_config_t *lcd_conf)
{
...
esp_err_t lcd_st7789_set_rotation(lcd_dir_t dir)
{
    esp_err_t ret;
    uint8_t reg_data = 0;
    reg_data &= ~MADCTL_RGB;
...
esp_err_t lcd_st7789_get_info(lcd_info_t *info)
{
