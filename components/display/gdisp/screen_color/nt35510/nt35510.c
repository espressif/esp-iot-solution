...
static nt35510_dev_t g_lcd_handle;


lcd_driver_fun_t lcd_nt35510_default_driver = {
...
esp_err_t lcd_nt35510_init(const lcd_config_t *lcd_conf)
{
...
{
    memset(&g_lcd_handle, 0, sizeof(nt35510_dev_t));
    return LCD_IFACE_DEINIT(true);
}

esp_err_t lcd_nt35510_set_rotation(lcd_dir_t dir)
{
    esp_err_t ret;
    uint8_t reg_data = 0;
    reg_data &= ~MADCTL_RGB;
...
esp_err_t lcd_nt35510_get_info(lcd_info_t *info)
{
