...
static void test_init_lcd(void)
{
    ...
    esp_lcd_dpi_panel_config_t dpi_config = ST7123_1560_720_PANEL_60HZ_DPI_CONFIG(TEST_MIPI_DPI_PX_FORMAT);
    ...
    TEST_ESP_OK(esp_lcd_new_panel_st7123(mipi_dbi_io, &panel_config, &panel_handle));
...
TEST_CASE("test st7123 to draw pattern with MIPI interface", "[st7123][draw_pattern]")
{
...
TEST_CASE("test st7123 to draw color bar with MIPI interface", "[st7123][draw_color_bar]")
{
    ESP_LOGI(TAG, "Initialize LCD device");
    test_init_lcd();
...
TEST_CASE("test st7123 to rotate with MIPI interface", "[st7123][rotate]")
{
    ESP_LOGI(TAG, "Initialize LCD device");
    test_init_lcd();
...
{
    /**
    *  ___ _____ _____ _ ____  _____
    * / ___|_   _|___  / |___ \|___ /
    * \___ \ | |    / /| | __) | |_ \
    *  ___) || |   / / | |/ __/ ___) |
    * |____/ |_|  /_/  |_|_____|____/
    */
    printf("     ___ _____ _____ _ ____  _____  \r\n");
    printf("    / ___|_   _|___  / |___ \\|___/ \r\n");
    printf("    \\___ \\ | |    / /| | __) | |_ \\ \r\n");
    printf("     ___) || |   / / | |/ __/ ___) | \r\n");
    printf("    |____/ |_|  /_/  |_|_____|____/ \r\n");
    unity_run_menu();
}
#endif
