...
static void test_init_lcd(void)
{
    ...
    ESP_LOGI(TAG, "Install LCD driver of hx8399");
    esp_lcd_dpi_panel_config_t dpi_config = HX8399_1080_1920_PANEL_30HZ_DPI_CONFIG(TEST_MIPI_DPI_PX_FORMAT);
    ...
    TEST_ESP_OK(esp_lcd_new_panel_hx8399(mipi_dbi_io, &panel_config, &panel_handle));
...
TEST_CASE("test hx8399 to draw pattern with MIPI interface", "[hx8399][draw_pattern]")
{
...
TEST_CASE("test hx8399 to draw color bar with MIPI interface", "[hx8399][draw_color_bar]")
{
    ESP_LOGI(TAG, "Initialize LCD device");
    test_init_lcd();
...
void app_main(void)
{
    ...
    */
    printf("  _   ___  _____ _____ ___   ___\r\n");
    printf(" | | | \\ \\/ ( _ )___ // _ \\ / _ \\ \r\n");
    printf(" | |_| |\\  // _ \\ |_ \\ (_) | (_) |\r\n");
    printf(" |  _  |/  \\ (_) |__) \\__, |\\__, |\r\n");
