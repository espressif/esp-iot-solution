 ...
 */
typedef struct {
    const gc9503_mipi_lcd_init_cmd_t *init_cmds;         /*!< Pointer to initialization commands array. Set to NULL if using default commands.
 ...
 *
 */
#define GC9503_MIPI_PANEL_BUS_DSI_2CH_CONFIG()                \
    {                                                    \
        .bus_id = 0,                                     \
        .num_data_lanes = 2,                             \
        .phy_clk_src = 0,                                \
        .lane_bit_rate_mbps = 580,                       \
    }
 ...
 *
 */
#define GC9503_MIPI_PANEL_IO_DBI_CONFIG()  \
    {                                 \
        .virtual_channel = 0,         \
        .lcd_cmd_bits = 8,            \
        .lcd_param_bits = 8,          \
 ...
 *
 */
#define GC9503_MIPI_480_800_PANEL_60HZ_DPI_CONFIG(px_format) \
    {                                                    \
 ...
 *
 */
#define GC9503_MIPI_480_800_PANEL_60HZ_DPI_CONFIG_CF(color_format) \
    {                                                    \
        .dpi_clk_src = MIPI_DSI_DPI_CLK_SRC_DEFAULT,     \
