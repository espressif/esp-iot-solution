...
.. note::
   ...
   对于仅有 USB Serial/JTAG 功能的芯片，请使用 `usb_serial_jtag_echo <https://github.com/espressif/esp-idf/tree/master/examples/peripherals/usb_serial_jtag/usb_serial_jtag_echo>`_ 示例进行测试。
