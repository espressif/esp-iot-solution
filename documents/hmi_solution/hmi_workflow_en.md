...
7. Develop application code.
    ...
    - **Setting interface**: use a label to display the setting-related text and a [roller](littlevgl/littlevgl_guide_en.md#roller-lv_roller) to display all the setting options.
        ```
