# BSP: ESP32-H4-KBD-KIT

ESP32-H4-KBD-KIT is the board support package for the keyboard example on ESP32-H4. GPIO definitions are in `include/bsp/keyboard.h`. Hardware reference currently follows the ESP-KeyBoard design below.
