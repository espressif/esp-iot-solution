...
#define HID_RPT_ID_ABS_MOUSE_IN  5   // Absolute mouse input report ID
...
enum {
    ...
    // Report absolute mouse input
    HIDD_LE_IDX_REPORT_ABS_MOUSE_IN_CHAR,
    HIDD_LE_IDX_REPORT_ABS_MOUSE_IN_VAL,
    HIDD_LE_IDX_REPORT_ABS_MOUSE_IN_CCC,
    HIDD_LE_IDX_REPORT_ABS_MOUSE_IN_REP_REF,
