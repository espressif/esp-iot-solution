...
1. Set the target to an Xtensa-based chip: `idf.py set-target esp32` (or esp32s2/esp32s3)
...
1. Set the target to a RISC-V-based chip: `idf.py set-target esp32c6` (or esp32c61/esp32p4)
2. Build the project: `idf.py build`
3. Copy the generated ELF file:
```
...
exec [Configuration parameters] <file>
    ...
    file: ELF application file name with full path
```
