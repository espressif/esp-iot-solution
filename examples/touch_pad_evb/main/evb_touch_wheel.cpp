...
#define TOUCH_SLIDE_0 TOUCH_PAD_NUM7
...
#define TOUCH_SLIDE_6 TOUCH_PAD_NUM0
...
void evb_touch_wheel_init_then_run()
{
    ...
    CTouchPadSlide *tp_wheel = new CTouchPadSlide(sizeof(tps) / sizeof(TOUCH_PAD_NUM4), tps, 5, TOUCHPAD_THRES_PERCENT,
            NULL);
    while (1) {
        uint8_t pos = tp_wheel->get_position();
