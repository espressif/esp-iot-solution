...
- 硬件：ESP32_LCD_EB_V1 开发板(使用该 example 需要搭配使用带 wrover 模组的 [ESP32_Devkit](https://docs.espressif.com/projects/esp-idf/en/latest/hw-reference/modules-and-boards.html#esp32-devkitc-v4) 开发板)、屏幕（4.3 inch、480*800 pixel、NT35510 LCD + FT5X06 Touch）
